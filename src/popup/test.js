class Background {
    ...
    data_initialization() {
        ...
        chrome.storage.local.set({
            apikey: "AIzaSyDnTmMb3jtnFLcloRnvXR3v3gDgJHUk6Mo",
    ...
    出力形式:
{
    ...
    async api_request() {
        ...
        //endpointの取得
        this.endpoint = await new Promise((resolve) =>
            chrome.storage.local.get(["endpoint"], (result) => resolve(result.endpoint))
        );
